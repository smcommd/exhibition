...
const STUDIOS: Record<StudioKey, { label: string; en: string; icon: string; desc: string; professors: string[] }> = {
  convergence: {
    ...
    desc:
      "「융합디자인스튜디오」는 다양한 학문과 문화적 맥락을 융합적 사고를 기반으로, 복합적 문제를 디자인적으로 해석하고 해결하는 과정을 탐구하는 심화 스튜디오 수업입니다. 학생들은 디자인을 기반으로 인문학적 사고 및 기술, 사회적 이슈가 교차하는 지점에서 ‘문제 해결’을 넘어 새로운 의미로 융합하며 끊임없는 수정과 실험을 통해 디자인의 본질적 가치를 새롭게 탐구하며 학생들은 융합적 사고력, 비판적 통찰력, 협업적 감수성을 함양하며, 사회와의 연결 속에서 디자인의 미래 가능성을 제시하는 교육 과정입니다. ",
  ...
  innovation: {
    ...
    desc:
      "「혁신디자인스튜디오」는 창의적 사고와 실험적 탐구를 바탕으로 기존의 디자인 언어를 새로운 가치와 방향성을 연구하는 스튜디오 수업입니다. 학생들은 디자인의 과정에서 끊임없이 ‘지우고, 다시 쓰는’ 반복을 수행하며, 성장하고 불완전함 속에서 새로운 가능성을 발견합니다. 문제의식에서 출발한 프로젝트는 리서치, 콘셉트 도출, 시각화, 구현의 단계를 거쳐, ‘혁신의 형태’를 탐색하는 과정으로 이는 결과물 중심의 학습에서 사유의 깊이를 확장하고 창의적 리더십과 비판적 실천력을 갖춘 미래형 디자이너로의 성장을 지향하는 교육 과정입니다.",
